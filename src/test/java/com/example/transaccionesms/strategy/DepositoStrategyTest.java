...
public class DepositoStrategyTest {
    ...
    @InjectMocks
    private DepositoStrategy depositoStrategy;
    ...
    @Test
    @DisplayName("Ejecuta la estrategia de depósito correctamente")
    void testEjecutar() {
        ...
        TransactionResponse actualResponse = depositoStrategy.ejecutar(transaccionRepository, transaccionMapper, request);
